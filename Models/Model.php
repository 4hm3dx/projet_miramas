...
{   //* Début de la Classe
    ...
    public function get_all_nom_list()
    {
        if (isset($_POST['nom'])) {
    ...
    public function get_all_message_mail_list()
    {
        if (isset($_POST['mail'])) {
            ...
            // Préparer la requête SQL pour sélectionner tous les utilisateurs ayant le même nom
            $r = $this->bd->prepare("SELECT u.id, u.nom, u.prenom, u.mail, r.admin, r.annonceur, r.abonnee FROM utilisateur u JOIN roles r ON u.id_roles = r.id WHERE mail = :mail;");
    ...
    public function get_all_prenom()
    {
        // Préparer la requête SQL pour sélectionner tous les livres dans l'ordre alphabétique par prenom
        $r = $this->bd->prepare("SELECT distinct nom FROM utilisateur;");
    ...
    public function get_all_prenom_list()
    {
