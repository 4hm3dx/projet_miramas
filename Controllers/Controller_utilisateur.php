...
// error_reporting(E_ALL);
    class Controller_utilisateur extends Controller
    {
        ...
        {
            $m = Model::get_model();
            $data = ["utilisateur_mail" => $m->get_all_utilisateur_mail(), "position" => 1];
        ...
        public function action_all_utilisateur_mail_list()
        {
            ...
            if (isset($_POST['mail_utilisateur'])) {
                ...
                $data = ["utilisateur_mail_list" => $m->get_all_utilisateur_mail_list(), "utilisateur_mail" => $m->get_all_utilisateur_mail(), "position" => 2];
                $this->render("all_utilisateur_mail", $data);
            }
        }
