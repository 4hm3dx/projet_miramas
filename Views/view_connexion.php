<div class="formulaire_inscription_utilisateur">
    <form action="" method="POST" id="formulaire_inscription">
        <fieldset>
            ...
            <label class="label_nom" for="nom_utilisateur_inscription">Nom :</label>
            <input type="text" name="nom_utilisateur_inscription" id="nom_utilisateur_inscription">
            <label class="label_prenom" for="prenom_utilisateur_inscription">Prénom : </label>
            <input type="text" name="prenom_utilisateur_inscription" id="prenom_utilisateur_inscription">
            <label class="label_mail" for="mail_utilisateur_inscription">E-mail : </label>
            <input type="email" name="mail_utilisateur_inscription" id="mail_utilisateur_inscription">
            <label class="label_mdp" for="mdp_utilisateur_inscription">Mot De Passe : </label>
            ...
            <br>
            <label class="label_confirme" for="confirme_mdp_utilisateur_inscription">Confirmation : </label>
            ...
            <div class="condition_general_utilisation">
                <p>
                    <label class="label_checkbox_condition" for="condition_general"></label>
...
<div class="formulaire_connexion_utilisateur">
    <form action="" method="POST" id="formulaire_connexion">
        <fieldset>
            ...
            <label class="label_mail_connexion" for="mail_utilisateur_connexion">E-mail : </label>
            <input type="email" name="mail_utilisateur_connexion" id="mail_utilisateur_connexion">
            <label class="label_mdp_connexion" for="mdp_utilisateur_connexion">Mot De Passe : </label>
